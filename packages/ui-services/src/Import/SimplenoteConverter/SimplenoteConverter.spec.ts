...
describe('SimplenoteConverter', () => {
  it('should parse', () => {
    ...
    expect(result?.[0].content.appData['org.standardnotes.sn'].trashed).toBe(false)
    ...
    expect(result?.[1].content.appData['org.standardnotes.sn'].trashed).toBe(false)
    ...
    expect(result?.[2].content.appData['org.standardnotes.sn'].trashed).toBe(true)
  })
})
