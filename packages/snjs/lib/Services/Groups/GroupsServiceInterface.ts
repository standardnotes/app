...
import { GroupInterface, GroupUserInterface, GroupPermission } from '@standardnotes/api'
...
export interface GroupsServiceInterface extends AbstractService<GroupsServiceEvent> {
  ...
  addItemToGroup(group: GroupInterface, item: DecryptedItemInterface): Promise<undefined | ClientDisplayableError>
}
