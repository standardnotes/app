  ...
  return (
    <PreferencesPane>
      <PreferencesGroup>
        ...
        <PreferencesSegment>
          <Subtitle>{c('B7.FilesSubscriptionHelp.Help.Confirmation').t`Can I collaborate with others on a note?`}</Subtitle>
          <Text>
            {c('B7.FilesSubscriptionHelp.Help.Info')
        ...
        <HorizontalSeparator classes="my-4" />
        <PreferencesSegment>
          <Subtitle>{c('B7.FilesSubscriptionHelp.Help.Confirmation').t`Can I use Standard Notes totally offline?`}</Subtitle>
          <Text>
            {c('B7.FilesSubscriptionHelp.Help.Info')
