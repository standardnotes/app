...
const HelpAndFeedback = ({ application }: { application: WebApplication }) => {
  ...
  return (
    <PreferencesPane>
      <PreferencesGroup>
        <PreferencesSegment>
          <Title>{c('B7.Help.Info').t`Frequently asked questions`}</Title>
          <div className="h-2 w-full" />
          <Subtitle>{c('B7.Help.Confirmation').t`Who can read my private notes?`}</Subtitle>
          <Text>
            {c('B7.Help.Info')
            ...
            <a
              ...
              onClick={handleClick}
            >
              {c('B7.Help.Info').t`Privacy Manifesto.`}
            </a>
          </Text>
          {application.isNativeIOS() && (
            <>
              <LinkButton
                className="mt-3"
                label={c('B7.Help.Label').t`Privacy Policy`}
                link="https://standardnotes.com/privacy"
                onClick={handleClick}
              />
              <LinkButton
                className="mt-3"
                label={c('B7.Help.Label').t`Terms of Use`}
        ...
        <PreferencesSegment>
          <Subtitle>{c('B7.Help.Confirmation').t`Can I collaborate with others on a note?`}</Subtitle>
          <Text>
            {c('B7.Help.Info')
        ...
        <HorizontalSeparator classes="my-4" />
        <PreferencesSegment>
          <Subtitle>{c('B7.Help.Confirmation').t`Can I use Standard Notes totally offline?`}</Subtitle>
          <Text>
            {c('B7.Help.Info')
            ...
            <a
              ...
              onClick={handleClick}
            >
              {c('B7.Help.Info').t`more details here.`}
            </a>
          </Text>
        </PreferencesSegment>
        <HorizontalSeparator classes="my-4" />
        <PreferencesSegment>
          <Subtitle>{c('B7.Help.Confirmation').t`Can’t find your question here?`}</Subtitle>
          <LinkButton
            className="mt-3"
            label={c('B7.Help.Label').t`Open FAQ`}
      ...
      <PreferencesGroup>
        <PreferencesSegment>
          <Title>{c('B7.Help.Info').t`Community forum`}</Title>
          <Text>
            {c('B7.Help.Info')
          ...
          <LinkButton
            className="mt-3"
            label={c('B7.Help.Label').t`Go to the forum`}
      ...
      <PreferencesGroup>
        <PreferencesSegment>
          <Title>{c('B7.Help.Info').t`Discord server`}</Title>
          <Text>
            {c('B7.Help.Info')
          ...
          <LinkButton
            ...
            label={c('B7.Help.Label').t`Join our Discord`}
            onClick={handleClick}
          />
        </PreferencesSegment>
      </PreferencesGroup>
      <PreferencesGroup>
        <PreferencesSegment>
          <Title>{c('B7.Help.Confirmation').t`Account related issue?`}</Title>
          <Text>
            {c('B7.Help.Info').t`Send an email to help@standardnotes.com and we’ll sort it out.`}
          </Text>
          <LinkButton
            className="mt-3"
            link="mailto: help@standardnotes.com"
            label={c('B7.Help.Label').t`Email us`}
            onClick={handleClick}
          />
        </PreferencesSegment>
      </PreferencesGroup>
