      ...
      <div className="flex flex-grow flex-col gap-4">
        <div className="flex flex-row flex-wrap items-center gap-1">
          <div className="text-sm">
            ...
            <span className="align-middle">
              Enter your <b>{c('B6.Preferences.Security.Label').t`secret key`}</b>:
            </span>
          </div>
          <DecoratedInput
        ...
        <div className="flex flex-row flex-wrap items-center gap-1">
          <div className="text-sm">
            <Bullet className="align-middle" />
            <span className="align-middle">
              Verify the <b>{c('B6.Preferences.Security.Label').t`authentication code`}</b> generated by your authenticator app:
            </span>
          </div>
          <DecoratedInput
        ...
        {act.verificationStatus === 'invalid-auth-code' && (
          <div className="flex-grow text-sm text-danger">{c('B6.Preferences.Security.Info').t`Incorrect authentication code, please try again.`}</div>
        )}
        {act.verificationStatus === 'invalid-secret' && (
          <div className="flex-grow text-sm text-danger">{c('B6.Preferences.Security.Info').t`Incorrect secret key, please try again.`}</div>
        )}
      </div>
    </div>
  )
