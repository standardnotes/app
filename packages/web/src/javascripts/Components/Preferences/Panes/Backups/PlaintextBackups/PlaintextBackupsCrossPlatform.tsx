    ...
    <>
      <PreferencesGroup>
        <PreferencesSegment>
          ...
          <Subtitle>{c('B6.Preferences.Backups.Subtitle').t`Automatically save backups of all your notes into plaintext, non-encrypted folders.`}</Subtitle>
          <Text className="mt-3">{c('B6.Preferences.Backups.Info').t`To enable plaintext backups, use the Standard Notes desktop application.`}</Text>
        </PreferencesSegment>
      </PreferencesGroup>
    </>
  )
