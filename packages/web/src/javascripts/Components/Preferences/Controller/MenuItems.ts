...
export const PREFERENCES_MENU_ITEMS: PreferencesMenuItem[] = [
  ...
  { id: 'listed', label: c('B6.Preferences.Other.Label').t`Listed`, icon: 'listed', order: 7 },
  ...
  { id: 'get-free-month', label: c('B7.FilesSubscriptionHelp.Subscription.Label').t`Get a free month`, icon: 'star', order: 10 },
