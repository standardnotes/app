...
const CalendarScroller: FunctionComponent<Props> = ({
  ...
  const [date, setDate] = useState(currentListDate || new Date())
  ...
  const resetCalendarCenteringOnDate = useCallback(
    (date: Date) => {
  ...
  const handleDaySelection = useCallback(
    (date: Date) => {
      resetCalendarCenteringOnDate(date)
      onDateSelect(date)
      setDate(date)
    },
    [onDateSelect, setDate, resetCalendarCenteringOnDate],
  )
            ...
            return (
              ...
              >
                <Calendar
                  ...
                  selectedTemplateDay={selectedTemplateDay}
                />
              </div>
            )
          })}
