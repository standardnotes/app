...
const StyledDisplayOptionsButton = styled(DisclosureButton).attrs(() => ({
  className:
    'flex justify-center items-center min-w-8 h-8 bg-text-padding hover:bg-contrast focus:bg-contrast text-neutral border-1 border-solid border-border rounded-full cursor-pointer',
}))<{
  pressed: boolean
}>`
