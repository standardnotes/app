...
const QuickSettingsMenu: FunctionComponent<MenuProps> = ({ closeMenu }) => {
  ...
  return (
    <Menu a11yLabel={c('B2.SharedUI.AriaLabel').t`Quick settings menu`}>
      {editorStackComponents.length > 0 && (
        <MenuSection title={c('B2.SharedUI.Label').t`Tools`}>
