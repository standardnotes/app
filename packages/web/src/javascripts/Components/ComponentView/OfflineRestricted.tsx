        ...
        <div className={'sk-panel-content'}>
          <div className={'sk-panel-section stretch'}>
            ...
            <div className="text-base font-bold">
              {c('B2.SharedUI.Info')
                .t`You have restricted this component to not use a hosted version.`}
            </div>
            <div className={'sk-subtitle'}>
              {c('B2.SharedUI.Info').t`Locally-installed components are not available in the web application.`}
            </div>
            <div className={'sk-panel-row'} />
            <div className={'sk-panel-row'}>
              <div className={'sk-panel-column'}>
                <div className={'sk-p'}>{c('B2.SharedUI.Info').t`To continue, choose from the following options:`}</div>
                <ul className="mt-3 list-disc pl-8">
                  ...
                  <li className={'sk-p'}>{c('B2.SharedUI.Info').t`Use the desktop application.`}</li>
                </ul>
              </div>
            </div>
          </div>
