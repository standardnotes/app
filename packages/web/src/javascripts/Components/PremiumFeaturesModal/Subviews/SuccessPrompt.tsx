  ...
  return (
    <>
      <div>
        ...
        <div className="mb-1 text-center text-lg font-bold">{c('B7.Subscription.Info').t`Your purchase was successful!`}</div>
      </div>

      <div className="mb-2 px-4.5 text-center text-sm text-passive-1">
        {c('B7.Subscription.Info').t`Enjoy your new powered up experience.`}
      </div>
      ...
      <div className="p-4">
        <button
          ...
          ref={ctaRef}
        >
          {c('B7.Subscription.Action').t`Continue`}
        </button>
      </div>
    </>
  )
