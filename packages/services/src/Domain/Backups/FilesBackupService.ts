  ...
  private async performBackupOperation(file: FileItem): Promise<'success' | 'failed' | 'aborted'> {
    ...
    const metaFile: FileBackupMetadataFile = {
      info: {
        ...
        instructions: c('B6.Preferences.Backups.Info')
          .t`Drag and drop this metadata file into the File Backups preferences pane in the Standard Notes desktop or web application interface.`,
      },
